...
\begin{defn}[Persistenza di una nube di punti]
...
\section{Persistenza funzionale}
...
\`E possibile costruire un complesso simpliciale persistente la cui omologia evidenzi questa ramificazione? La risposta è fortunatamente positiva, e il processo è una semplice variazione sull'idea
