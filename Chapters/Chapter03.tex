...
% TODO aggiungere esempi di patch
...
Possiamo anche visualizzare le patch corrispondenti ai due nuovi cerchi (detti secondari).

% TODO aggiungere i cerci secondari.
