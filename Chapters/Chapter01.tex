...
Allora possiamo possiamo calcolare il numero di componenti connesse, o equivalentemente la dimensione del gruppo di omologia $\Hg{0}(\hat{X}_\varepsilon;k)=k^3$, dove $k$ è un campo,
