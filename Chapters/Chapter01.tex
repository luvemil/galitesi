...
Ad esempio si consideri un esagono regolare come in \cref{fig:exhagon}. Se $R$ è la misura del lato dell'esagono, le tre figure rappresentano $VR(X,r)$ rispettivamente con $0< r\leq R$, $R< r < \dfrac{\sqrt{3}R}{2}$, e $r > \dfrac{\sqrt{3}R}{2}$. 
