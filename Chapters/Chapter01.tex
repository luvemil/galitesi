...
Allora possiamo possiamo calcolare il numero di componenti connesse, o equivalentemente la dimensione del gruppo di omologia $\Hg{0}(\widehat{X}_\varepsilon;k)$, dove $k$ è un campo. La dimensione $\mathrm{dim}_k(\Hg{0}(\widehat{X}_\varepsilon;k))$ è 3 per un intervallo notevole di valori di $\varepsilon$, e da un certo $\overline{\varepsilon}$ in poi diventa 1.
